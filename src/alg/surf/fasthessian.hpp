...
#ifndef _SIM_ALG_SURF_FASTHESSIAN_HPP_
#define _SIM_ALG_SURF_FASTHESSIAN_HPP_
...
class FastHessian {
  ...
  public:
    ...
    FastHessian(std::vector<sim::alg::SurfLandmark> &ipts, 
  ...
  private:
    ...
    //! Initial sampling step for sim::alg::SurfLandmark detection
    int init_sample;
